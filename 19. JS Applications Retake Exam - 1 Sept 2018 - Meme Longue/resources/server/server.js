(function (global, factory) {
    ...
    userService.post("delete", onDelete);
    ...
    function onDelete(context, tokens, query, body) {
        return context.auth.delUser();
    }
    ...
    function initPlugin$1(settings) {
        ...
        return function decorateContext(context, request) {
            ...
            function delUser(body) {
                context.protectedStorage.delete("users", body._id);
                console.log(`targetUser: `, targetUser);
            }
    ...
    var protectedData = {
        users: {
            ...
            "5b8586681d803555d9d3512b": {
                email: "gencho@abv.bg",
                username: "gencho",
                avatarUrl: "http://images.uncyc.org/bg/thumb/5/5c/%D0%94%D1%8F%D0%B4%D0%BE%D0%9A%D0%BE%D0%BB%D0%B5%D0%B4%D0%B0.jpg/300px-%D0%94%D1%8F%D0%B4%D0%BE%D0%9A%D0%BE%D0%BB%D0%B5%D0%B4%D0%B0.jpg",
                hashedPassword:
                    "83313014ed3e2391aa1332615d2f053cf5c1bfe05ca1cbcb5582443822df6eb1",
            },
            "5b866864b6052705c47c1c0d": {
                email: "mini@abv.bg",
                username: "mini",
                avatarUrl: "https://static.vecteezy.com/system/resources/thumbnails/004/899/680/small/beautiful-blonde-woman-with-makeup-avatar-for-a-beauty-salon-illustration-in-the-cartoon-style-vector.jpg",
                hashedPassword:
                    "83313014ed3e2391aa1332615d2f053cf5c1bfe05ca1cbcb5582443822df6eb1",
            },
            "5b88e8caf427442c7704ff53": {
                email: "testwe@abv.bg",
                username: "testwe",
                avatarUrl: "https://static.vecteezy.com/system/resources/thumbnails/006/631/154/small_2x/portrait-of-caucasian-woman-avatar-of-female-person-icon-of-adult-in-flat-style-headshot-vector.jpg",
                hashedPassword:
                    "83313014ed3e2391aa1332615d2f053cf5c1bfe05ca1cbcb5582443822df6eb1",
            },
            "5b88f92bf427442c77056503": {
                email: "123@abv.bg",
                username: "testuser",
                avatarUrl: "https://static.vecteezy.com/system/resources/thumbnails/049/970/005/small/woman-in-traditional-asian-clothing-with-red-flowers-in-her-hair-looking-to-the-side-photo.jpg",
                hashedPassword:
                    "83313014ed3e2391aa1332615d2f053cf5c1bfe05ca1cbcb5582443822df6eb1",
            },
            "5b856bde1ab0f72634396fba": {
                email: "pencho@abv.bg",
                username: "pencho",
                avatarUrl: "https://img.freepik.com/premium-vector/beauty-girl-avatar-character-simple-vector_855703-380.jpg",
                hashedPassword:
                    "83313014ed3e2391aa1332615d2f053cf5c1bfe05ca1cbcb5582443822df6eb1",
            },
        },
    ...
    var seedData = {
        memes: {
            "5b88e5e28711b7350e387b0c": {
                creator: "gencho",
                title: "Честит Рожден Ден xd",
                _ownerId: "5b8586681d803555d9d3512b",
                description: "Много забавен мийм",
                imageUrl: "https://thriftyniftymommy.com/wp-content/uploads/2019/11/Happy-Birthday-Meme-3.jpg.webp",
                _createdOn: 1770295412101,
                _id: "0",
            },
            "5b88e5fe88774d3ccdc3d693": {
                creator: "gencho",
                title: "Return Return моме калино.",
                _ownerId: "5b8586681d803555d9d3512b",
                description: "Положението е страшно!! ",
                imageUrl: "https://i.imgflip.com/1il5gj.jpg",
                _createdOn: 1770295422101,
                _id: "0",
            },
            "5b88e63dc8596c35095ff21f": {
                creator: "user",
                title: "Разбираемо...",
                _ownerId: "5b856bde1ab0f72634396fba",
                description: "И аз така...",
                imageUrl: "https://img.buzzfeed.com/buzzfeed-static/static/2019-01/18/15/asset/buzzfeed-prod-web-03/sub-buzz-30619-1547843441-1.png?crop=499:405;0,23",
                _createdOn: 1770292422101,
                _id: "0",
            },
        },
    };
