...
export function setNavigation() {
    ...
    isLoggedIn
        ? authUl.innerHTML = '<li><a href="/app">Catalog</a></li><li><a href="/search">Search</a></li><li><a href="/create">Create Album</a></li><li><a href="/logout">Logout</a></li>'
        : authUl.innerHTML = '<li><a href="/app">Catalog</a></li><li><a href="/search">Search</a></li><li><a href="/login">Login</a></li><li><a href="/register">Register</a></li>';
}
